...
const file_template_proto_rawDesc = "" +
	"\n" +
	"\x0etemplate.proto\x12\vtemplate.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbd\x01\n" +
	"\x15CreateTemplateRequest\x12\x1b\n" +
	"\tclient_id\x18\x01 \x01(\tR\bclientId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04body\x18\x03 \x01(\tR\x04body\x12)\n" +
	"\x0esender_name_id\x18\x04 \x01(\tH\x00R\fsenderNameId\x88\x01\x01\x12!\n" +
	"\ftraffic_type\x18\x05 \x01(\tR\vtrafficTypeB\x11\n" +
	"\x0f_sender_name_id\"O\n" +
	"\x16CreateTemplateResponse\x125\n" +
	"\btemplate\x18\x01 \x01(\v2\x19.template.v1.TemplateInfoR\btemplate\"\xff\x01\n" +
	...
	"\x0esender_name_id\x18\x06 \x01(\tH\x03R\fsenderNameId\x88\x01\x01B\a\n" +
	"\x05_nameB\a\n" +
	"\x05_bodyB\x0f\n" +
	"\r_traffic_typeB\x11\n" +
	"\x0f_sender_name_id\"O\n" +
	...
	"\x05total\x18\x02 \x01(\x05R\x05total\"\xa9\x04\n" +

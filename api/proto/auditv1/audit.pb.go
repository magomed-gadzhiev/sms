...
type QueryAuditLogRequest struct {
	...
	ResourceType  string                 `protobuf:"bytes,8,opt,name=resource_type,json=resourceType,proto3" json:"resource_type,omitempty"` // Фильтр по типу ресурса (опционально)
...
const file_audit_audit_proto_rawDesc = "" +
	"\n" +
	"\x11audit/audit.proto\x12\baudit.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa6\x02\n" +
	...
	"\bper_page\x18\a \x01(\x05R\aperPage\x12#\n" +
	"\rresource_type\x18\b \x01(\tR\fresourceType\"\x95\x01\n" +

...
// CancelMessageRequest представляет запрос на отмену сообщения
...
func (x *CancelMessageRequest) Reset()         { *x = CancelMessageRequest{} }
func (x *CancelMessageRequest) String() string { return protoimpl.X.MessageStringOf(x) }
...
// CancelMessageResponse представляет ответ на отмену сообщения
...
func (x *CancelMessageResponse) Reset()         { *x = CancelMessageResponse{} }
func (x *CancelMessageResponse) String() string { return protoimpl.X.MessageStringOf(x) }
...
const file_messaging_messaging_proto_rawDesc = "" +
	"\n" +
	"\x19messaging/messaging.proto\x12\fmessaging.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8e\x04\n" +
	...
	"\bmessages\x18\x02 \x03(\v2 .messaging.v1.SendMessageRequestR\bmessages\"\x98\x01\n" +
	...
	"\tclient_id\x18\x02 \x01(\tR\bclientId\"\xd6\x03\n" +
	...
	"\x0eupdated_status\x18\x02 \x01(\tR\rupdatedStatus\"\xfe\x03\n" +
	...
	"providerId\x12\x19\n" +
	"\broute_id\x18\r \x01(\tR\arouteId2\xce\x03\n" +
	...
	"\n" +
	"ProcessDLR\x12\x1f.messaging.v1.ProcessDLRRequest\x1a .messaging.v1.ProcessDLRResponseB:Z8github.com/smpp-server/smpp-server/api/proto/messagingv1b\x06proto3"
...
var file_messaging_messaging_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
var file_messaging_messaging_proto_depIdxs = []int32{
	11, // 0: messaging.v1.SendMessageRequest.validity_period:type_name -> google.protobuf.Timestamp
	11, // 1: messaging.v1.SendMessageResponse.created_at:type_name -> google.protobuf.Timestamp
	0,  // 2: messaging.v1.SendBatchRequest.messages:type_name -> messaging.v1.SendMessageRequest
	1,  // 3: messaging.v1.SendBatchResponse.results:type_name -> messaging.v1.SendMessageResponse
	11, // 4: messaging.v1.GetMessageStatusResponse.created_at:type_name -> google.protobuf.Timestamp
	11, // 5: messaging.v1.GetMessageStatusResponse.submitted_at:type_name -> google.protobuf.Timestamp
	11, // 6: messaging.v1.GetMessageStatusResponse.delivered_at:type_name -> google.protobuf.Timestamp
	11, // 7: messaging.v1.GetMessageStatusResponse.failed_at:type_name -> google.protobuf.Timestamp
	11, // 8: messaging.v1.GetMessageHistoryRequest.from:type_name -> google.protobuf.Timestamp
	11, // 9: messaging.v1.GetMessageHistoryRequest.to:type_name -> google.protobuf.Timestamp
	10, // 10: messaging.v1.GetMessageHistoryResponse.messages:type_name -> messaging.v1.MessageInfo
	11, // 11: messaging.v1.ProcessDLRRequest.done_date:type_name -> google.protobuf.Timestamp
	11, // 12: messaging.v1.MessageInfo.created_at:type_name -> google.protobuf.Timestamp
	11, // 13: messaging.v1.MessageInfo.submitted_at:type_name -> google.protobuf.Timestamp
	11, // 14: messaging.v1.MessageInfo.delivered_at:type_name -> google.protobuf.Timestamp
	11, // 15: messaging.v1.MessageInfo.failed_at:type_name -> google.protobuf.Timestamp
	0,  // 16: messaging.v1.MessagingService.SendMessage:input_type -> messaging.v1.SendMessageRequest
	2,  // 17: messaging.v1.MessagingService.SendBatch:input_type -> messaging.v1.SendBatchRequest
	4,  // 18: messaging.v1.MessagingService.GetMessageStatus:input_type -> messaging.v1.GetMessageStatusRequest
	6,  // 19: messaging.v1.MessagingService.GetMessageHistory:input_type -> messaging.v1.GetMessageHistoryRequest
	8,  // 20: messaging.v1.MessagingService.ProcessDLR:input_type -> messaging.v1.ProcessDLRRequest
	1,  // 21: messaging.v1.MessagingService.SendMessage:output_type -> messaging.v1.SendMessageResponse
	3,  // 22: messaging.v1.MessagingService.SendBatch:output_type -> messaging.v1.SendBatchResponse
	5,  // 23: messaging.v1.MessagingService.GetMessageStatus:output_type -> messaging.v1.GetMessageStatusResponse
	7,  // 24: messaging.v1.MessagingService.GetMessageHistory:output_type -> messaging.v1.GetMessageHistoryResponse
	9,  // 25: messaging.v1.MessagingService.ProcessDLR:output_type -> messaging.v1.ProcessDLRResponse

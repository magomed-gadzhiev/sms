...
export function StatisticsFilterBar({ mode, filters, onFiltersChange, onApply, loading, polling }: StatisticsFilterBarProps) {
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        ...
        {!isMonitoring && (
          <>
            ...
            <button className="flex items-center gap-1 px-2.5 py-1 rounded-md text-xs border border-gray-200 text-gray-500 hover:border-gray-300">
              <Calendar size={12} />

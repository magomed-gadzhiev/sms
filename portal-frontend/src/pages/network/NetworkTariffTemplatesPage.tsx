                    ...
                    <DropdownMenu.Root>
                      ...
                      <DropdownMenu.Portal>
                        <DropdownMenu.Content
                          align="end"
                          sideOffset={4}
                          className="z-50 min-w-40 rounded-md border border-slate-200 bg-white dark:bg-slate-900 py-1 shadow-lg"
                        >
                          <DropdownMenu.Item
                          ...
                          <DropdownMenu.Item
                            ...
                            className="px-3 py-1.5 text-sm text-red-700 dark:text-red-300 outline-none cursor-pointer hover:bg-red-50 data-[highlighted]:bg-red-50 data-[disabled]:text-slate-400 data-[disabled]:cursor-not-allowed data-[disabled]:hover:bg-transparent"
                            onSelect={() => {

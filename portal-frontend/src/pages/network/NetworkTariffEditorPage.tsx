...
// - Matrix: TariffMatrix component in always-editable mode (no «Режим правки» toggle).
...
// - EditorSaveBar: sticky bottom bar that shows dirty-count and Save/Cancel buttons.
//   It communicates with TariffMatrix via TariffMatrixHandle (forwardRef) + callbacks.
...
import { InheritanceLegend } from '../../components/tariffs/InheritanceLegend';
...
export function NetworkTariffEditorPage() {
  ...
  const matrixRef = useRef<TariffMatrixHandle | null>(null);
  ...
  if (!data.plan) {
    ...
    return (
      <div className="flex flex-col">
        <div className="sticky top-0 z-10 bg-white dark:bg-slate-900 border-b border-slate-200">
    ...
    <div className="flex flex-col">
      ...
      <div className="px-6 py-4">
        ...
        <EditorSaveBar
          ...
          saving={matrixSaving}
          onSave={() => matrixRef.current?.save()}
          onCancel={() => matrixRef.current?.reset()}
        />

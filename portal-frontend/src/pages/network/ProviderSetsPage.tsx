              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {s.is_default && (
                      <span className="px-2 py-0.5 text-xs rounded bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300 shrink-0">
                        default
                      </span>
                    )}
                  </div>
                ...
                <tbody>
                  {items.length === 0 ? (
                    ...
                    items
                      ...
                      .map((it) => (
                        <tr key={it.provider_id} className="border-t border-gray-100 dark:border-slate-800">
                          ...
                          <td className="p-2">
                            <input
                              ...
                              className="w-20 rounded border border-gray-300 dark:border-slate-600 px-2 py-1 text-sm"
                            />
                          </td>
          ...
          <div className="space-y-1 max-h-96 overflow-y-auto">
            {availableProviders.map((p) => (
              <button
                ...
                className="w-full text-left p-3 rounded hover:bg-gray-50 dark:hover:bg-slate-800 border border-gray-100 dark:border-slate-800"
              >

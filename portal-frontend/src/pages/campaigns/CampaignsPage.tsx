  ...
  return (
    <div>
      ...
      <div className="mb-4 flex items-center gap-3">
        <label htmlFor="campaign-status-filter" className="text-sm font-medium text-gray-700 dark:text-slate-300 whitespace-nowrap">
          Статус:
        </label>
        <select
          ...
          className="border border-gray-300 dark:border-slate-600 rounded-md px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
      ...
      {error && <p role="alert" className="text-red-600 dark:text-red-400 mb-4">{error}</p>}
      {deleteError && <p role="alert" className="text-red-600 dark:text-red-400 mb-4">{deleteError}</p>}

      {!loading && !error && campaigns.length === 0 && (
        <div className="text-center py-12 text-gray-500 dark:text-slate-400">
          <svg className="mx-auto mb-3 w-12 h-12 text-gray-300 dark:text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">

    ...
    <>
      ...
      <Modal open={showPeriodForm} onClose={() => setShowPeriodForm(false)} title="Добавить период">
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Стратегия *</label>
            <Select
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-400 dark:text-slate-500 mt-1">Следующий период автоматически закроет текущий</p>
          </div>
      ...
      <Modal open={showTierForm} onClose={() => setShowTierForm(false)} title={editTier ? 'Изменить тир' : 'Добавить тир'}>
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">От (сегментов)</label>
              <Input
                type="number"
                min={0}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Цена за сегмент *</label>
              <Input
                type="text"
                placeholder="0.05"

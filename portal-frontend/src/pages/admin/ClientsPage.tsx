    ...
    <>
      ...
      <Modal open={!!blockClient} onClose={() => { setBlockClient(null); setBlockReason(''); }} title="Заблокировать клиента">
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="block-reason" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">
            ...
            />
            <p className="mt-1 text-xs text-gray-500 dark:text-slate-400">{blockReason.length}/500</p>
          </div>
          <div className="flex justify-end gap-3 pt-2">

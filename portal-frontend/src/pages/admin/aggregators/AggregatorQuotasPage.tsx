...
export function AggregatorQuotasPage() {
  ...
  return (
    <>
      ...
      {/* Active Quota Card */}
      <div className="mb-6">
        <h2 className="text-base font-semibold text-gray-700 mb-3">Текущая активная квота</h2>
        {activeQuota ? (
          <div className="bg-white border border-gray-200 rounded-lg p-5 space-y-4">
            <div className="flex items-start justify-between">
              <div className="grid grid-cols-2 gap-x-10 gap-y-2 text-sm">
                ...
                <div>
                  <span className="text-gray-500">Лимит сегментов:</span>{' '}
                ...
                <div>
                  <span className="text-gray-500">Ставка превышения:</span>{' '}
                  <span className="font-mono font-medium">
                    {activeQuota.overage_rate} {activeQuota.currency}
                  </span>
                </div>
                <div>
                  <span className="text-gray-500">Авто-продление:</span>{' '}
      ...
      {/* History Table */}
      <h2 className="text-base font-semibold text-gray-700 mb-3">История квот</h2>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            {selectedCountry ? (
              ...
              <div className="text-sm text-gray-400 dark:text-slate-500 p-4 border border-gray-200 dark:border-slate-700 rounded-lg">Выберите страну</div>
            )}
          </div>
            ...
            {selectedOperator ? (
              <>
                <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg p-4 mb-4">
                  <h3 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-3">Настройки</h3>
                ...
                <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg p-4">
                  <h3 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-3">Префиксы</h3>
                  ...
                  <ul className="space-y-1">
                    {prefixes.map((p) => (
                      <li key={p.prefix_id} className="flex items-center justify-between py-1 px-2 bg-gray-50 dark:bg-slate-950 rounded text-sm">
                    ...
                    {prefixes.length === 0 && <li className="text-sm text-gray-400 dark:text-slate-500">Нет префиксов</li>}
                  </ul>
                </div>

                <div className="mt-6">
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-slate-300 mb-2">Юр. лица</h3>
                  <div className="border border-dashed border-gray-300 dark:border-slate-600 rounded-lg p-4 text-center text-sm text-gray-400 dark:text-slate-500">
                    Управление юр. лицами оператора — ожидает backend API
                  </div>
                </div>
              </>
            ) : (
              <div className="text-sm text-gray-400 dark:text-slate-500 p-4 border border-gray-200 dark:border-slate-700 rounded-lg">Выберите оператора</div>
            )}
          </div>
        </div>
      )}

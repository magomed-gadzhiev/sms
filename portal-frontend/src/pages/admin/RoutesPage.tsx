        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700 text-sm">
          <thead className="bg-gray-50 dark:bg-slate-950">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-slate-400">Оператор</th>
              <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-slate-400">Канал</th>
              <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-slate-400">Провайдер</th>
              <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-slate-400">Юр. лицо</th>
              <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-slate-400">Статус</th>
              <th className="px-4 py-3 text-right font-medium text-gray-600 dark:text-slate-400">Действия</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
            ...
            {routes.map((route, index) => (
              ...
              >
                <td className="px-3 py-3 text-gray-400 dark:text-slate-500 select-none text-center cursor-grab active:cursor-grabbing">⠿</td>
                <td className="px-4 py-3">
                  {route.operator_id === null ? (
                    <span className="font-bold text-blue-600 dark:text-blue-400">All Networks</span>
                  ) : (
                    <span>{route.operator_name}</span>
                  )}
                </td>
                <td className="px-4 py-3 uppercase text-xs font-medium text-gray-700 dark:text-slate-300">
                  {route.channel_type}
                </td>
          ...
          {isAllNetworks && (
            <div>
              ...
              {formErrors.legal_entity_id && (
                <p className="text-xs text-red-500 dark:text-red-400 mt-1">{formErrors.legal_entity_id}</p>
              )}
            </div>
          )}
          <Select

...
export function MonitoringPage() {
  ...
  return (
    <>
      ...
      {error && <div className="mb-4 p-3 bg-yellow-50 dark:bg-yellow-950/40 border border-yellow-200 dark:border-yellow-800 rounded text-sm text-yellow-800 dark:text-yellow-200">Проблема с подключением. Автоматическая переподключение...</div>}

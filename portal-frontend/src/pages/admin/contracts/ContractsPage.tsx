...
export function ContractsPage() {
  ...
  const columns: Column<Contract>[] = [
    ...
    },
    {
      ...
      render: (row) =>
        row.legal_entity_inn ? (
          <div>
            <span className="font-mono text-xs text-gray-500 dark:text-slate-400">{row.legal_entity_inn}</span>
    ...
    },
    {
      key: 'start_date',
      header: 'С',
      render: (row) => <span className="text-sm text-gray-600 dark:text-slate-400">{row.start_date || '—'}</span>,
    },
    {
      key: 'end_date',
      header: 'По',
      render: (row) => <span className="text-sm text-gray-600 dark:text-slate-400">{row.end_date || '—'}</span>,
    },
  ];
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              className="w-full border border-gray-300 dark:border-slate-600 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
              rows={3}

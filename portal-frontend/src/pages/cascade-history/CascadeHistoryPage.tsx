...
export function CascadeHistoryPage() {
  ...
  return (
    <div className="p-6">
      ...
      {error && (
        <div className="mb-4 p-3 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 rounded text-red-700 dark:text-red-300 text-sm">{error}</div>
      )}

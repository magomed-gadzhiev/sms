...
export function DefaultSendersPage() {
  usePageTitle('Имена отправителей по умолчанию');
  ...
  return (
    <div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg border p-6 max-w-lg">
              ...
              return (
                <div key={code}>
                  ...
                  <select
                    ...
                    className="w-full rounded-md border border-gray-300 dark:border-slate-600 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
                  >

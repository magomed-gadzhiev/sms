...
import (
	...
	auditv1 "github.com/smpp-server/smpp-server/api/proto/auditv1"
	"github.com/smpp-server/smpp-server/internal/config"
	"github.com/smpp-server/smpp-server/internal/monitoring"
	auditgrpc "github.com/smpp-server/smpp-server/internal/services/audit/grpc"
	auditrepo "github.com/smpp-server/smpp-server/internal/services/audit/infrastructure/repository"
...
func main() {
	...
	logger := shared.WithService("audit-service")
	...
	auditRepo := auditrepo.NewAuditRepository(dbConn.DB)

	// Создание health checker
	healthChecker := monitoring.NewHealthChecker("audit-service", cfg.Service.Version)
	...
	// HTTP сервер для health checks и metrics
	...
	logger.Info().Msg("Audit Service остановлен")
}

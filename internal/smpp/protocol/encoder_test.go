...
func TestEncoder_EncodePDU(t *testing.T) {
	encoder := NewEncoder()
...
func TestEncoder_EncodeBind(t *testing.T) {
	encoder := NewEncoder()
...
func TestEncoder_EncodeSubmitSM(t *testing.T) {
	encoder := NewEncoder()
...
func TestEncoder_EncodeSubmitSMResp(t *testing.T) {
	encoder := NewEncoder()
...
func TestEncoder_EncodeDeliverSM(t *testing.T) {
	encoder := NewEncoder()
...
func TestEncoder_EncodeEnquireLink(t *testing.T) {
	encoder := NewEncoder()
...
func TestEncoder_EncodeUnbind(t *testing.T) {
	encoder := NewEncoder()
...
func TestEncoder_WriteCString(t *testing.T) {
	encoder := NewEncoder()
...
func TestEncoder_WriteTLV(t *testing.T) {
	encoder := NewEncoder()

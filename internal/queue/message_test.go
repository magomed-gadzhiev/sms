...
func TestKafkaMessage_Serialize(t *testing.T) {
...
func TestKafkaMessage_ToMessage(t *testing.T) {
	providerID := uuid.New()
	routeID := uuid.New()
	clientID := uuid.New()
...
func TestKafkaMessage_ToMessage_DefaultMaxRetries(t *testing.T) {
	km := &queue.KafkaMessage{
		ID:          "test-id",
		MessageID:   uuid.New(),
		Source:      "12345",
...
func TestDLRMessage_Serialize(t *testing.T) {
	messageID := uuid.New()
	providerID := uuid.New()
	now := time.Now()
...
func TestDeserializeDLR(t *testing.T) {
...
func TestDeserializeDLR_InvalidJSON(t *testing.T) {
	invalidData := []byte("{invalid json}")
...
func TestFailedMessage_Serialize(t *testing.T) {
	messageID := uuid.New()
...
func TestDeserializeFailed(t *testing.T) {
...
func TestDeserializeFailed_InvalidJSON(t *testing.T) {
	invalidData := []byte("{invalid json}")

...
// MessageStatus — статус сообщения. Канонический владелец словаря —
// internal/shared/messagestatus; здесь только alias-алиасы для совместимости.
type MessageStatus = messagestatus.Status

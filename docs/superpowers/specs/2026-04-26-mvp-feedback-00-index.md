...
|---|---|---|---|---|
| 1 | Быстрая отправка | trivial (правка спеки) | спека описывает старое состояние, код корректнее | [01](2026-04-26-mvp-feedback-01-quick-send-design.md) |
...
| 3 | SMPP → «Подключения» | S | не переименовано, два дубля в меню, Edit нет | [03](2026-04-26-mvp-feedback-03-smpp-connections-rename-design.md) |
...
| 9 | Кампании-wizard — косметика | S | wizard уже 4-шаговый, 4 точечные правки + скрыть «Повторы» | [09](2026-04-26-mvp-feedback-09-campaigns-wizard-cosmetics-design.md) |
